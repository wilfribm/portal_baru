...
<title>Public Materi-{{$materipublic->nama_materi}}</title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-success mb-3">
    <div class="container-fluid">
        <a href="#" class="navbar-brand mr-3">DutaTani </a>
...
<div class="col-md-6 d-flex justify-content-center">
  <iframe width="750" height="500" src="https://www.youtube.com/embed/{{$materipublic->link_video}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<br>

<div class="col-md-6 col-lg-4 col-xl-3">
  <h3 >{{$materipublic->nama_materi}}</h3>
  <p>{{$materipublic->deskripsi}}</p>
  <h3 >Download Materi:</h3>
  <button><a href="./../materipengajar/{{$materipublic->dokumen}}">Download File</a></button>
    ...
    <footer>
        <div class="row no-gutters" >
            <div class="col-md-6 mb-3 " id="pad">
                <p class="p-0 m-0"> Copyright &copy; 2020 Dutatani</p>
            </div>
