                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="{{$berita->id}}/edit">Edit</a>
                              <div class="dropdown-divider"></div>
                                {!!Form::open(['action' => ['\App\Http\Controllers\BeritaController@destroy', 
                                        ...
                                        <div class="row">
                                            ...
                                            @if (!empty($berita)) 
                                                <div class="col-md-8 col-6">
                                                    <img style= "width: 40%" src="./../../foto_berita/{{$berita->foto}}">
                                                </div>    
                                            @else
                                                <div class="col-md-8 col-6">
                                                    Tidak ada gambar
