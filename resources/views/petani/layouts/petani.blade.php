...
<head>
  ...
  <title>DutaTani | @yield('title')</title>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{asset('/lte3/plugins/plugins/jqvmap/jqvmap.min.css') }}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('/img/favicon.ico') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Duta Tani</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('/images/1600067755.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
